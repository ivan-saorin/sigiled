...
**Version:** 0.3-en · **Date:** 2026-08-03 · **Status:** ALL decisions ratified — DEC-01…10 ratified by il Re on 2026-08-03 (in chat, with the platform complete and live-verified); DEC-11…20, DEC-22 and DEC-23 ratified earlier, DEC-21 and DEC-24 registered, DEC-25 ratified 2026-08-08, DEC-26 ratified 2026-08-09; DEC-12 **amended** 2026-08-03 → platform **SIGILED** (`ivan-saorin/sigiled`, domains `sigiled.dev`/`sigilled.dev`). The contract is 2.1.0, no longer draft.

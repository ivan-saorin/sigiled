...
**Versione:** 0.3 · **Data:** 2026-08-03 · **Stato:** DEC-11…20 e DEC-22 ratificate, DEC-21 registrata (esito verifica naming, sessione 1b); DEC-12 **emendata** 2026-08-03 → piattaforma **SIGILED** (`ivan-saorin/sigiled`, domini `sigiled.dev`/`sigilled.dev`); DEC-01…10 restano da ratificare

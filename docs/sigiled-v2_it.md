...
**Versione:** 0.3 · **Data:** 2026-08-03 · **Stato:** TUTTE le decisioni ratificate — DEC-01…10 ratificate dal Re il 2026-08-03 (in chat, a piattaforma completa e verificata dal vivo); DEC-11…20, DEC-22 e DEC-23 ratificate in precedenza, DEC-21 e DEC-24 registrate, DEC-25 ratificata 2026-08-08; DEC-12 **emendata** 2026-08-03 → piattaforma **SIGILED** (`ivan-saorin/sigiled`, domini `sigiled.dev`/`sigilled.dev`). Il contratto è 2.0.0, non più draft

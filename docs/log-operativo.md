...
- **Prossimo passo previsto**: sessione 2/4 (log macchina `GET /mgr/projects/{p}/log`, sync-template, `template_behind`); ratifica Apache-2.0 dal Re; passi operatore nel runbook.

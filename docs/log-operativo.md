...
_aggiornato: 2026-08-02, sessione a8748f78 (sessione 2/4 — log macchina + recepimento)_
...
- **Prossimo passo previsto**: **sessione 3/4** del build plan (auth a due gambe — prerequisito operatore: token API Authentik in stack env); dal Re: ratifica Apache-2.0 (o MIT); dall'operatore: package `vm-base` → Public (passi nel runbook), Pages + DNS per il flip.
